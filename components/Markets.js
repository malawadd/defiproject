...
const GET_OPEN_POOLS = gql`
  query ($state: String!, $orderBy: BigInt!, $orderDirection: String!) {
    poolEntities(orderBy: $orderBy, orderDirection: $orderDirection, where: { state: $state }) {
      createdAtTimestamp
      poolId
      tokenAddress
      basePrice
...
export const Markets = ({ account }) => {
  ...
  // This is an helper function to get the cover loss percentage.
  ...
  return (
    ...
    <h3 className={s.tabHeader}>Open Taamin Pools</h3>
    <div>
